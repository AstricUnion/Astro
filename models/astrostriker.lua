...
local blasterHolos = part {
    ...
    holo { Vector(-8.5, 136, 13), Angle(0, 270, -90), "models/combine_dropship_container.mdl", Vector(0.285, 0.15, 0.06), color = Color(255, 40, 40) },
    holo { Vector(8.5, 136, 13), Angle(0, 270, 90), "models/combine_dropship_container.mdl", Vector(0.285, 0.15, 0.06), color = Color(255, 40, 40) },
    holo { Vector(0, 136, 0), Angle(0, 270, 0), "models/combine_dropship_container.mdl", Vector(0.285, 0.15, 0.05), color = Color(255, 40, 40) },
    holo { Vector(0, 136, 21), Angle(0, 270, 180), "models/combine_dropship_container.mdl", Vector(0.285, 0.15, 0.05), color = Color(255, 40, 40) },
    holo { Vector(0, 195, 13), Angle(90, 90, 0), "models/Items/combine_rifle_ammo01.mdl", Vector(2, 2, 2), color = Color(255, 40, 40) },
    holo { Vector(0, 210, 13), Angle(90, 90, 0), "models/props_phx/wheels/magnetic_large.mdl", Vector(0.2, 0.2, 0.75), color = Color(255, 40, 40), material = metGibMat },
    holo { Vector(0, 210, 13), Angle(90, 90, 0), "models/props_phx/wheels/magnetic_large.mdl", Vector(0.245, 0.245, 1.1), color = Color(255, 40, 40), material = metGibMat },
    ...
    holo { Vector(0, 140, 13), Angle(0, 90, 0), "models/xqm/jetengine.mdl", Vector(0.5, 1, 1), color = Color(255, 40, 40), material = metGibMat },
    ...
    -- holo { Vector(0, 145, 17), Angle(45, 180, 90), "models/props_combine/combine_mine01.mdl", Vector(0.7, 0.7, 5.1), color = Color(255, 40, 40) },
    holo { Vector(34, 95, 2.3), Angle(0, 5, -90), "models/props_combine/combine_bridge.mdl", Vector(0.1, 0.15, 0.29), color = Color(185, 30, 30), material = "models/props_canal/metalwall005b" },
    -- holo { Vector(0, 60, 0), Angle(-22.5, 180, 90), "models/props_combine/combine_mine01.mdl", Vector(1.5, 1.5, 5.1), color = Color(255, 40, 40) },
    holo { Vector(0, 215, 0), Angle(90, 270, 0), "models/props_combine/combine_mortar01b.mdl", Vector(0.75, 0.75, 2.5), color = Color(185, 30, 30) }
}
...
local chassisModel = part {
    ...
    holo { Vector(0, 70, 40), Angle(0, 0, 20), "models/props_combine/combine_train02b.mdl", Vector(0.4, 0.1, 0.15), color = Color(255, 40, 40) },
    holo { Vector(0, 70, 40), Angle(0, 180, -20), "models/props_combine/combine_train02b.mdl", Vector(0.4, 0.1, 0.15), color = Color(255, 40, 40) },
    holo { Vector(-35, -40, 28), Angle(0, 50, 0), "models/props_combine/combineinnerwallcluster1024_002a.mdl", Vector(0.1, 0.1, 0.045), color = Color(255, 40, 40) },
    holo { Vector(-35, 40, 28), Angle(0, -50, 0), "models/props_combine/combineinnerwallcluster1024_002a.mdl", Vector(0.1, 0.1, 0.045), color = Color(255, 40, 40) },
    ...
    holo { Vector(-25, 35, 28), Angle(0, -50, 0), "models/props_combine/combineinnerwallcluster1024_002a.mdl", Vector(0.09, 0.09, 0.045), color = Color(255, 40, 40) },
    holo { Vector(25, 25, -30), Angle(30, 45, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    holo { Vector(25, -25, -30), Angle(30, -45, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    holo { Vector(-25, 25, -30), Angle(30, 135, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    holo { Vector(-25, -25, -30), Angle(30, -135, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    holo { Vector(40, 0, -30), Angle(30, 0, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    holo { Vector(-40, 0, -30), Angle(30, 180, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    holo { Vector(0, 40, -30), Angle(30, 90, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    holo { Vector(0, -40, -30), Angle(30, -90, 0), "models/props_combine/combine_barricade_med01a.mdl", Vector(0.125, 0.35, 0.35), color = Color(255, 40, 40) },
    ...
    holo { Vector(45, 45, -15), Angle(-70, 45, 0), "models/combine_dropship_container.mdl", Vector(0.125, 0.15, 0.15), color = Color(255, 40, 40) },
    holo { Vector(-50, 0, -25), Angle(155, 0, 0), "models/props_combine/combineinnerwallcluster1024_001a.mdl", Vector(0.045, 0.025, 0.045), color = Color(255, 40, 40) },
    holo { Vector(50, 0, -25), Angle(155, 180, 0), "models/props_combine/combineinnerwallcluster1024_001a.mdl", Vector(0.045, 0.025, 0.045), color = Color(255, 40, 40) },
    holo { Vector(0, 50, -25), Angle(155, -90, 0), "models/props_combine/combineinnerwallcluster1024_001a.mdl", Vector(0.045, 0.025, 0.045), color = Color(255, 40, 40) },
    holo { Vector(0, -50, -25), Angle(155, 90, 0), "models/props_combine/combineinnerwallcluster1024_001a.mdl", Vector(0.045, 0.025, 0.045), color = Color(255, 40, 40) },
...
local hubFrontModel = part {
    ...
    holo { nil, Angle(0, -90, 0), "models/props_combine/combine_train02a.mdl", Vector(0.15, 0.175, 0.075), color = Color(255, 40, 40), material = "models/gibs/metalgibs/metal_gibs" },
    holo { Vector(0, 0, -20), Angle(180, 0, 0), "models/hunter/tubes/tube2x2x025d.mdl", Vector(1.1, 1.1, 0.2), color = Color(255, 40, 40), material = "models/gibs/metalgibs/metal_gibs" },
    holo { Vector(1.25, -1.25, -20), Angle(180, 0, 0), "models/hunter/tubes/tube2x2x025d.mdl", Vector(1.075, 1.075, 0.15), noLight = true, color = Color(255, 40, 40), material = "models/debug/debugwhite" },
    holo { Vector(0, 0, -20), Angle(180, 180, 0), "models/hunter/tubes/tube2x2x025d.mdl", Vector(1.1, 1.1, 0.2), color = Color(255, 40, 40), material = "models/gibs/metalgibs/metal_gibs" },
    holo { Vector(-1.25, 1.25, -20), Angle(180, 180, 0), "models/hunter/tubes/tube2x2x025d.mdl", Vector(1.075, 1.075, 0.15), noLight = true, color = Color(255, 40, 40), material = "models/debug/debugwhite" },
    holo { Vector(0, 0, -4), Angle(0, 90, 180), "models/props_combine/combine_mine01.mdl", Vector(2.75, 2.75, 2.7), color = Color(255, 40, 40) },
...
local hubRearModel = part {
    ...
    holo { Vector(0, 0, 0), Angle(180, 180, 0), "models/hunter/tubes/tube2x2x025d.mdl", Vector(0.8, 0.8, 0.2), color = Color(255, 40, 40), material = "models/gibs/metalgibs/metal_gibs" },
    holo { Vector(-1.25, 1.25, 0), Angle(180, 180, 0), "models/hunter/tubes/tube2x2x025d.mdl", Vector(0.775, 0.775, 0.15), noLight = true, color = Color(255, 40, 40), material = "models/debug/debugwhite" },
    ...
    holo { Vector(0, 0, 13), Angle(0, 90, 180), "models/props_combine/combine_mine01.mdl", Vector(2.5, 2.5, 2.8), color = Color(255, 40, 40) },
...
local larmModel = part {
    ...
    holo { Vector(0, 45, 0), Angle(0, 90, 0), "models/props_wasteland/laundry_washer003.mdl", Vector(1.1, 0.85, 0.75 ), color = Color(255, 40, 40), material = "models/gibs/metalgibs/metal_gibs" },
